...
vi.mock('@deepseek-ai/dsh-client-ui-primitives', () => {
  ...
  return {
    ...
    IconChevronDownOutlineMedium: component,
    IconChevronUpOutlineMedium: component,
    IconCloseOutlineRegular: component,
    IconCordisPluginOutlineMedium: component,
    IconDataOutlineRegular: component,
    IconDownloadOutlineRegular: component,
    IconPlayOutlineRegular: component,
    IconGlobeOutlineMedium: component,
    ...
    IconWarningOutlineRegular: component,
  }
})
