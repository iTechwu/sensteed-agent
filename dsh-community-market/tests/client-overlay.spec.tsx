...
vi.mock('@deepseek-ai/dsh-client-ui-primitives', () => {
  ...
  return {
    ...
    IconCordisPluginOutlineMedium: icon,
    IconCordisPluginOutlineRegular: icon,
    IconDataOutlineRegular: icon,
    IconDataOutlineMedium: icon,
    IconDownloadOutlineRegular: icon,
    IconDownloadOutlineMedium: icon,
    IconPlayOutlineRegular: icon,
    IconGlobeOutlineMedium: icon,
    IconGlobeOutlineRegular: icon,
    IconLoadingOutlineRegular: icon,
    IconPlusOutlineRegular: icon,
    IconPlusOutlineMedium: icon,
